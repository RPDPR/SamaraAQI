...
export const Header: FC = () => {
  return (
    <div className="w-full sticky top-0 z-100 h-20 lg:h-20 4k:h-40 min-h-20 lg:min-h-20 4k:min-h-40 bg-white text-center flex justify-center items-center px-14 lg:px-0 4k:px-0">
