...
export const HistoryTile: FC = () => {
  ...
  return (
    <div className="w-full h-full bg-black lg:rounded-2xl 4k:rounded-4xl flex flex-col justify-between px-10 lg:px-5 4k:px-10 pt-8 lg:pt-12 4k:pt-24 pb-10 lg:pb-9 4k:pb-18">
      <div className="text-white text-left font-sans font-medium text-[55px] lg:text-[55px] 4k:text-[110px] leading-[100%] lg:leading-[100%] 4k:leading-[100%]">
